...
>(({ className, children, ...props }, ref) => (
    <DrawerPrimitive.Content
        ref={ref}
        className={cn(
            'fixed flex flex-col bg-background border border-b-none rounded-t-[10px] bottom-0 h-auto max-h-[97%] mx-[-1px] inset-x-0 z-50',
            className
        )}
        {...props}
    >
...
>(({ className, ...props }, ref) => <DrawerPrimitive.Description ref={ref} className={cn('font-normal text-base', className)} {...props} />);
